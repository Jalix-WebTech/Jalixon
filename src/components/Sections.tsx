...
jalixon.com
      ...
      {/* Phone mockup */}
      <div
        className="hidden sm:block absolute -bottom-10 -left-6 w-40 rounded-[26px] glass border-gradient overflow-hidden shadow-2xl animate-floaty"
      ...
      <div
        className="hidden sm:block absolute -top-6 -right-6 glass border-gradient rounded-xl p-4 w-44 animate-floaty"
